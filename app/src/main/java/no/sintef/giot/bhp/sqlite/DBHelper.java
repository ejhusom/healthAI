...
public class DBHelper extends SQLiteOpenHelper {
     ...
     */
    public String getAllEntriesAsCsv() throws IOException, CsvDataTypeMismatchException, CsvRequiredFieldEmptyException {
        List<HeartRateVariability> data = getAllEntries();
        // create a string writer
        StringWriter writer = new StringWriter();
        ColumnPositionMappingStrategy mappingStrategy = new ColumnPositionMappingStrategy();
        // Correct order of columns
        String[] columns = new String[]{TIMESTAMP_COL, RMSSD_COL, COVERAGE_COL, LOW_FREQUENCY_COL, HIGH_FREQUENCY_COL};
        mappingStrategy.setColumnMapping(columns);
        mappingStrategy.setType(HeartRateVariability.class);
        // create a csv writer
        StatefulBeanToCsv<HeartRateVariability> csvWriter = new StatefulBeanToCsvBuilder<HeartRateVariability>(writer)
